...
class CollegePrivateSubscription extends StatefulWidget {
  const CollegePrivateSubscription({super.key});

  @override
  State<CollegePrivateSubscription> createState() => _CollegePrivateSubscriptionState();
}

class _CollegePrivateSubscriptionState extends State<CollegePrivateSubscription> {
  @override
  Widget build(BuildContext context) {
   var screenSize = MediaQuery.of(context).size;
    return Scaffold(
      appBar: AppBar(
        title:Text('College Private') 
        ),
        body: 
